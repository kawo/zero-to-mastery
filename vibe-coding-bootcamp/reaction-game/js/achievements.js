...
(() => {
  ...
  const LIST = [
    ...
    { id: 'saved', kind: 'decoy', title: 'Saved by the Shield',
      desc: 'Let a shield absorb a failed round.',
      test: (c) => c.stats.shieldSaves >= 1 },
    { id: 'powerPlayer', kind: 'volume', title: 'Power Player',
      desc: 'Use 10 power-ups.',
      progress: (c) => [c.stats.powerUpsUsed, 10] },
    { id: 'onTheBoard', kind: 'focus', title: 'On the Board',
      desc: 'Get a verified run on the leaderboard.',
      test: (c) => c.stats.verifiedRuns >= 1 },
