...
export function PlayerBar() {
  ...
  return (
    <section aria-label="Player" className="border-t border-border bg-surface">
          ...
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            >
              ...
              <span className="min-w-0">
                ...
                <span className="block truncate text-xs text-muted">{currentTrack.artist}</span>
              </span>
            </Link>
      ...
      <div className="hidden h-[5.5rem] grid-cols-[minmax(0,1fr)_minmax(0,2fr)_minmax(0,1fr)] items-center gap-4 px-4 md:grid">
        <div className="flex min-w-0 items-center gap-3">
          {currentTrack ? (
            <>
              <Link to="/now-playing" aria-label="Open Now Playing" className="rounded-md">
        ...
        <div className="flex items-center justify-end gap-1">
          {!onNowPlaying && (
            <Link to="/now-playing" className="icon-btn" aria-label="Open Now Playing">
